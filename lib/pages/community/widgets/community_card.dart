...
class CommunityCard extends StatelessWidget {
  final String title;
  final String brand;
  final String? logoUrl; // 👈 tambahkan opsional jika logo diambil dari Firestore
    ...
    return Card(
      ...
      child: ListTile(
        ...
        leading: CircleAvatar(
          ...
          child: _buildLogo(brandLogos, brand, logoUrl), // 👈 gunakan fungsi helper
        ),
        title: Text(
          title,
          style: TextStyle(
...
/// ============================================================
/// 🧩 Fungsi Helper: Logo builder (Base64 / Network / Asset)
/// ============================================================
...
Widget _buildLogo(Map<String, String> brandLogos, String brand, String? logoUrl) {
  // 1️⃣ Jika logoUrl dari Firestore tersedia
  ...
  // 2️⃣ Jika tidak ada logoUrl → fallback ke asset brand
  ...
  // 3️⃣ Fallback terakhir: huruf pertama brand
  return Text(
    brand[0].toUpperCase(),
    style: TextStyle(
